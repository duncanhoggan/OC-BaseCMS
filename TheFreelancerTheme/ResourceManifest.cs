...
namespace OrchardCore.Themes.TheFreelancerTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-jQuery")
                .SetUrl("~/TheFreelancerTheme/vendor/jquery/jquery.min.js", "~/TheFreelancerTheme/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-jQuery.slim")
                .SetUrl("~/TheFreelancerTheme/vendor/jquery/jquery.slim.min.js", "~/TheFreelancerTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-jQuery.easing")
                .SetDependencies("TheFreelancerTheme-vendor-jQuery")
                .SetUrl("~/TheFreelancerTheme/vendor/jquery-easing/jquery.easing.min.js", "~/TheFreelancerTheme/vendor/jquery-easing/jquery.easing.js")
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-bootstrap")
                .SetDependencies("TheFreelancerTheme-vendor-jQuery")
                .SetUrl("~/TheFreelancerTheme/vendor/bootstrap/js/bootstrap.min.js", "~/TheFreelancerTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-bootstrap-bundle")
                .SetDependencies("TheFreelancerTheme-vendor-jQuery")
                .SetUrl("~/TheFreelancerTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/TheFreelancerTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("TheFreelancerTheme-vendor-bootstrap")
                .SetUrl("~/TheFreelancerTheme/vendor/bootstrap/css/bootstrap.min.css", "~/TheFreelancerTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("TheFreelancerTheme-bootstrap-oc")
                .SetUrl("~/TheFreelancerTheme/css/bootstrap-oc.min.css", "~/TheFreelancerTheme/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("TheFreelancerTheme-vendor-font-awesome")
                .SetUrl("~/TheFreelancerTheme/vendor/fontawesome-free/css/all.min.css", "~/TheFreelancerTheme/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("TheFreelancerTheme-vendor-font-awesome")
